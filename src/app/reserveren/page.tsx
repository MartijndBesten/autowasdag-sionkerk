...
export const metadata: Metadata = {
  ...
  description: "Reserveer eenvoudig een wasbeurt voor de Autowasdag van de Sionkerk op zaterdag 22 augustus.",
};
  ...
  return (
    <main className="min-h-screen" style={{ background: "linear-gradient(160deg, #faf6e8 0%, #f5edd6 60%, #e8f5ef 100%)" }}>
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 pt-28 pb-20">
        ...
        {/* Header */}
        <div className="mb-10">
          <span className="label-small">Autowasdag · 22 augustus</span>
