...
const DEFAULT_STEPS = [
  ...
  { number: "02", title: "Kies uw wasbeurt", description: "Kies voor Buitenkant wassen (€7,50, alleen buitenkant) of Compleet (€12,50, buitenkant wassen + stofzuigen + eenvoudige interieurreiniging)." },
...
const DEFAULT_TIMELINE: TimelineItem[] = [
  ...
  { time: "10:00", title: "Koffie & gebak",    desc: "Gratis koffie bij uw reservering. Gebak en lekkernijen zijn verkrijgbaar.", color: "amber" },
...
export default function HowItWorks({ action }: { action: Action | null }) {
  ...
  const coffeeNote = action?.coffee_text
    ?? `Laat uw reservering zien voor een <em>gratis koffie</em>. Gebak en snacks zijn verkrijgbaar.`;
