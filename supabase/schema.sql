...
-- ── Sitecontent in instellingen ──────────────────────────────────────────────
-- Sitecontent wordt opgeslagen als JSONB-sleutel 'sitecontent' in de bestaande
-- tabel public.instellingen. Zie migrations/004_sitecontent_seed.sql.
